...
propriedades = [
    ...
    classesMonopoly.Propriedade(yellow, dark_gray, "Farmácia", "1", 1, None, 200, [150, 200, 250, 300, 350]),
    classesMonopoly.Propriedade(yellow, dark_gray, "Restaurante", "2", 1, None, 300, [150, 200, 250, 300, 350]),
    classesMonopoly.Propriedade(yellow, dark_gray, "Supermercado", "3", 1, None, 200, [150, 200, 250, 300, 350]),
    ...
    classesMonopoly.Propriedade(yellow, dark_gray, "Posto de Gasolina", "5", 1, None, 350, [150, 200, 250, 300, 350]),
    ...
    classesMonopoly.Propriedade(yellow, dark_gray, "Barbearia", "10", 1, None, 150, [150, 200, 250, 300, 350]),
    classesMonopoly.Propriedade(yellow, dark_gray, "Academia", "11", 1, None, 200, [150, 200, 250, 300, 350]),
    ...
    classesMonopoly.Propriedade(yellow, dark_gray, "Cinema", "15", 1, None, 200, [150, 200, 250, 300, 350]),
    classesMonopoly.Propriedade(yellow, dark_gray, "Teatro", "16", 1, None, 150, [150, 200, 250, 300, 350]),
    classesMonopoly.Propriedade(yellow, dark_gray, "Floricultura", "17", 1, None, 100, [150, 200, 250, 300, 350]),
    ...
    classesMonopoly.Propriedade(yellow, dark_gray, "Banco", "19", 1, None, 150, [150, 200, 250, 300, 350]),
    classesMonopoly.Propriedade(yellow, dark_gray, "Papelaria", "20", 1, None, 100, [150, 200, 250, 300, 350]),
    classesMonopoly.Propriedade(yellow, dark_gray, "Clínica Médica", "21", 1, None, 300, [150, 200, 250, 300, 350]),
    ...
    classesMonopoly.Propriedade(yellow, dark_gray, "Loja de brinquedos", "25", 1, None, 150, [150, 200, 250, 300, 350]),
    classesMonopoly.Propriedade(yellow, dark_gray, "Oficina Mecânica", "26", 1, None, 100, [150, 200, 250, 300, 350]),
    classesMonopoly.Propriedade(yellow, dark_gray, "Vá para o Congelamento", "27", 1, "Banco", 0, [150, 200, 250, 300, 350], "Vá para a prisão!"),
    classesMonopoly.Propriedade(yellow, dark_gray, "Açougue", "28", 1, None, 300, [150, 200, 250, 300, 350]),
    classesMonopoly.Propriedade(yellow, dark_gray, "Hamburgueria", "29", 1, None, 250, [150, 200, 250, 300, 350]),
    classesMonopoly.Propriedade(yellow, dark_gray, "Auto Shopping", "30", 1, None, 200, [150, 200, 250, 300, 350]),
    ...
    classesMonopoly.Propriedade(yellow, dark_gray, "Hortifruti", "34", 1, None, 400, [150, 200, 250, 300, 350]),
    classesMonopoly.Propriedade(yellow, dark_gray, "Loja de Informática", "35", 1, None, 350, [150, 200, 250, 300, 350])
]
