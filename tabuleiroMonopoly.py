...
propriedades = [
    classesMonopoly.Propriedade(yellow, dark_gray, "Inicio", "0", 1, "Banco", 150,   "Inicio do jogo"),
    classesMonopoly.Propriedade(yellow, dark_gray, "Farmácia", "1", 1, None, 300 ),
    classesMonopoly.Propriedade(yellow, dark_gray, "Restaurante", "2", 1, None, 350 ),
    classesMonopoly.Propriedade(yellow, dark_gray, "Supermercado", "3", 1, None, 400 ),
    classesMonopoly.Propriedade(dark_gray, dark_gray, "E Agora?", "4", 1, "Banco", 0,   "Tire uma carta será que hoje é seu dia de sorte?"),
    classesMonopoly.Propriedade(yellow, dark_gray, "Posto de Gasolina", "5", 1, None, 550 ),
    classesMonopoly.Propriedade(yellow, dark_gray, "Padaria", "6", 1, None, 250 ),
    classesMonopoly.Propriedade(yellow, dark_gray, "Livraria", "7", 1, None, 100 ),
    classesMonopoly.Propriedade(yellow, dark_gray, "Loja de Roupas", "8", 1, None, 150 ),
    classesMonopoly.Propriedade(yellow, dark_gray, "Congelamento", "9", 1, "Banco", 0,   "Você está apenas fazendo uma visita."),
    classesMonopoly.Propriedade(yellow, dark_gray, "Barbearia", "10", 1, None, 100 ),
    classesMonopoly.Propriedade(yellow, dark_gray, "Academia", "11", 1, None, 300 ),
    classesMonopoly.Propriedade(yellow, dark_gray, "Sorveteria", "12", 1, None, 100 ),
    classesMonopoly.Propriedade(dark_gray, dark_gray, "E Agora?", "13", 1, "Banco", 0,   "Tire uma carta será que hoje é seu dia de sorte?"),
    classesMonopoly.Propriedade(yellow, dark_gray, "Cafeteria", "14", 1, None, 150 ),
    classesMonopoly.Propriedade(yellow, dark_gray, "Cinema", "15", 1, None, 250 ),
    classesMonopoly.Propriedade(yellow, dark_gray, "Teatro", "16", 1, None, 350 ),
    classesMonopoly.Propriedade(yellow, dark_gray, "Floricultura", "17", 1, None, 150 ),
    classesMonopoly.Propriedade(yellow, dark_gray, "Férias", "18", 1, "Banco", 0,   "VocÊ está de ferias, fique uma vez sem jogar"),
    classesMonopoly.Propriedade(yellow, dark_gray, "Banco", "19", 1, None, 700 ),
    classesMonopoly.Propriedade(yellow, dark_gray, "Papelaria", "20", 1, None, 100 ),
    classesMonopoly.Propriedade(yellow, dark_gray, "Clínica Médica", "21", 1, None, 600 ),
    classesMonopoly.Propriedade(dark_gray, dark_gray, "E Agora?", "22", 1, "Banco", 0,   "Tire uma carta será que hoje é seu dia de sorte?"),
    classesMonopoly.Propriedade(yellow, dark_gray, "Pet Shop", "23", 1, None, 200 ),
    classesMonopoly.Propriedade(yellow, dark_gray, "Loja de cosmeticos", "24", 1, None, 200 ),
    classesMonopoly.Propriedade(yellow, dark_gray, "Loja de brinquedos", "25", 1, None, 250 ),
    classesMonopoly.Propriedade(yellow, dark_gray, "Oficina Mecânica", "26", 1, None, 300 ),
    classesMonopoly.Propriedade(yellow, dark_gray, "Vá para o Congelamento", "27", 1, "Banco", 0,   "Vá para a prisão!"),
    classesMonopoly.Propriedade(yellow, dark_gray, "Açougue", "28", 1, None, 200 ),
    classesMonopoly.Propriedade(yellow, dark_gray, "Hamburgueria", "29", 1, None, 250 ),
    classesMonopoly.Propriedade(yellow, dark_gray, "Loja de Carros", "30", 1, None, 500 ),
    classesMonopoly.Propriedade(dark_gray, dark_gray, "E Agora?", "31", 1, "Banco", 0,   "Tire uma carta será que hoje é seu dia de sorte?"),
    classesMonopoly.Propriedade(yellow, dark_gray, "Loja de Esportes", "32", 1, None, 300 ),
    classesMonopoly.Propriedade(yellow, dark_gray, "Pizzaria", "33", 1, None, 150 ),
    classesMonopoly.Propriedade(yellow, dark_gray, "Hortifruti", "34", 1, None, 150 ),
    classesMonopoly.Propriedade(yellow, dark_gray, "Loja de Informática", "35", 1, None, 300 )
]
